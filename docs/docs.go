...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/evoluciones/bandeja": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Texto de búsqueda (DNI, Nombre, NroAtencion)",
                        "name": "filtro",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/resultados/imagenes/detalle": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/resultados/laboratorio/detalle": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "ID de Producto CPT",
                        "name": "idProducto",
                        "in": "query",
                        "required": true
                    }
        ...
        "/catalogos/parametros-clinicos/{idGrupo}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID del grupo (1: Estado General, 2: Hidratación, 3: Conciencia/Glasgow, 4: Destino Alta, 5: Tipo Atención)",
                        "name": "idGrupo",
                        "in": "path",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.ParametroClinico"
                                            }
                                        }
                                    }
                                }
        ...
        "/dashrefcon/consulta-referencia-detalle": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Código de establecimiento destino (por defecto el configurado)",
                        "name": "establecimientoDestino",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Límite de resultados por página (por defecto el configurado)",
                        "name": "limite",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ConsultaMinsaResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/dashrefcon/referencias": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Mes (0 = todos los meses)",
                        "name": "mes",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Año de la referencia",
                        "name": "anio",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Estado de la referencia (3 ACEPTADO, 4 RECHAZADO, 5 PACIENTE RECIBIDO, 7 PACIENTE CITADO, 8 CONTRAREFERIDO)",
                        "name": "estado",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Código de la UPS",
                        "name": "ups",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Opción del reporte (1 total, 2 por estado, 3 por estado filtrado, 4 por estado y UPS)",
                        "name": "opcion",
                        "in": "query",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.ReferenciaPorMes"
                                            }
                                        }
                                    }
                                }
        ...
        "/dashrefcon/upss/{codigoRenipress}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Código RENIPRESS del establecimiento",
                        "name": "codigoRenipress",
                        "in": "path",
                        "required": true
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ListadoUpsResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/diagnosticos/atencion": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos del diagnóstico a registrar",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AgregarDiagnosticoAtencionRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.AgregarDiagnosticoAtencionResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/diagnosticos/atencion/{idAtencion}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "ID de Primera Atención",
                        "name": "idPrimeraAtencion",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "ID de Evolución",
                        "name": "idEvolucion",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.DiagnosticoAtencion"
                                            }
                                        }
                                    }
                                }
        ...
        "/establecimientos": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto a buscar (código, nombre o departamento)",
                        "name": "q",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Tipo de establecimiento: 1=Referencia, 0=Contrareferencia (0/Todos por defecto)",
                        "name": "tipo",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.EstablecimientoBusqueda"
                                            }
                                        }
                                    }
                                }
        ...
        "/pacientes/{idOrDoc}/datos-adicionales": {
            "get": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.PacienteDatosAdicionales"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Antecedentes a guardar",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Identificador o payload inválido",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/httpadapter.apiResponse"
        ...
        "/refcon/distritos-reniec/{idReniec}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "IdReniec del distrito",
                        "name": "idReniec",
                        "in": "path",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.DistritoReniec"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.Establecimiento"
                                            }
                                        }
                                    }
                                }
        ...
        "/refcon/hoja-referencia": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos de la referencia a generar",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.GenerarHojaReferenciaRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.GenerarHojaReferenciaResult"
                                        }
                                    }
                                }
                            ]
        ...
        "/sis/afiliado/{nrodoc}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Número de documento (DNI), obligatorio con intOpcion=1",
                        "name": "nrodoc",
                        "in": "path"
                    },
                    {
                        "type": "string",
                        "description": "Código DISA (obligatorio con intOpcion=2)",
                        "name": "strDisa",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Tipo de formato (obligatorio con intOpcion=2)",
                        "name": "strTipoFormato",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Número de contrato (obligatorio con intOpcion=2)",
                        "name": "strNroContrato",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "Tipo de documento (1=DNI, 3=CE), usado con intOpcion=1",
                        "name": "strTipoDocumento",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Opción de consulta: 1=por documento (default), 2=por afiliación",
                        "name": "intOpcion",
                        "in": "query"
                    }
                ],
        ...
        "/triaje/causas-externas-morbilidad": {
            "get": {
        ...
        "/triaje/referencias": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Texto de búsqueda por paciente o número de cuenta",
                        "name": "filtro",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Referencias de consulta externa",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
        ...
        "/triaje/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Datos del paciente y del triaje",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Datos clínicos editables del triaje",
                        "name": "triaje",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpadapter.createTriajeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Mensaje de resultado del SP",
                        "schema": {
                            "type": "object",
    ...
    "definitions": {
        "domain.AgregarDiagnosticoAtencionRequest": {
            "type": "object",
            "properties": {
                "codigoCIE10": {
                    "type": "string"
        ...
        "domain.AgregarDiagnosticoAtencionResponse": {
            "type": "object",
            "properties": {
                "descripcionSubclasificacion": {
                    "type": "string"
                },
        ...
        "domain.ConsultaMinsaDatos": {
            "type": "object",
            "properties": {
                "datos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ReferenciaMinsa"
                    }
                },
                "paginas": {
                    "type": "integer"
        ...
        "domain.ConsultaMinsaResponse": {
            ...
            "properties": {
                ...
                "datos": {
                    "$ref": "#/definitions/domain.ConsultaMinsaDatos"
                },
                "mensaje": {
                    "type": "string"
                }
        ...
        "domain.EstablecimientoBusqueda": {
            "type": "object",
            "properties": {
                "codigo": {
                    "type": "string"
        ...
        "domain.GenerarHojaReferenciaRequest": {
            "type": "object",
            "properties": {
                "estadoreferencia": {
                    "type": "string"
        ...
        "domain.GenerarHojaReferenciaResult": {
            "type": "object",
            "properties": {
                "archivoB64": {
                    "type": "string"
        ...
        "domain.ListadoUpsResponse": {
            ...
            "properties": {
                ...
                "datos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ListadoUpsItem"
                    }
                },
                "mensaje": {
                    "type": "string"
        ...
        "domain.PacienteDatosAdicionales": {
            "type": "object",
            "properties": {
                "anemia": {
                    "type": "integer"
        ...
        "domain.ReferenciaMinsa": {
            ...
            "properties": {
                ...
                "datos_referencia": {
                    "$ref": "#/definitions/domain.DatosReferenciaMinsa"
                },
                "datos_tutor": {
                    "$ref": "#/definitions/domain.DatosTutorMinsa"
                },
                "diagnosticos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.DiagnosticoMinsa"
                    }
                },
                "paciente": {
                    "$ref": "#/definitions/domain.PacienteMinsa"
                },
                "rownum": {
                    "type": "string"
                },
        ...
        "httpadapter.createTriajeRequest": {
            "type": "object",
            "properties": {
                "apellidoMaterno": {
                    "type": "string"
        ...
        "refconhttp.apiResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "error": {
                    "$ref": "#/definitions/refconhttp.apiError"
                },
                "success": {
                    "type": "boolean"
                }
